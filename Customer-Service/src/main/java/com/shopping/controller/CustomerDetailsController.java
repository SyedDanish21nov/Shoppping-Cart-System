...
public class CustomerDetailsController {
	...
	public String addOrder(@RequestBody OrderModel order) {
		return restTemplate.postForObject("http://Order-Microservice/order/addorder", order, String.class);
	}
	...
	public String deleteorder(@PathVariable("id") int id) {
		restTemplate.delete("http://Order-Microservice/order/delete/" + id, String.class);
